...
source12 = effect12.CreateSource(initspeed=5.0, initdirection= 2*math.pi*random.random(), initspeedrandrange=15.0, initdirectionrandrange=2*math.pi,
        ...
        if event.type == pygame.QUIT:
            ...
            if ct < 12:
                if ct%12 == 1:
                    ...
                    source12.CreateKeyframe(source12.curframe + 1, pos=pygame.mouse.get_pos(), initspeed=5.0,initdirection=0.0, initspeedrandrange=0.0,initdirectionrandrange=15.0, particlesperframe=1)
