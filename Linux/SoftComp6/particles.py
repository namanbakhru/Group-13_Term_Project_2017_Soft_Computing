...
class Particle:
    ...
    def Update(self):
        ...
        global xpos13, ypos13, xpos15, ypos15, xpos17, ypos17, xpos19, ypos19

        tt = 10*random.random()

        if constants.ck % 20 == 1:
        ...
        elif constants.ck %20 == 11:
            self.pos = [self.pos[0], self.pos[1]]
            xpos11 = self.pos[0]
            ypos11 = self.pos[1]
        elif constants.ck%20 == 12:
            xpos = self.pos[0]
            ypos = self.pos[1]
            x1pos = xpos + 10
            y1pos = ypos
        ...
        elif constants.ck % 20 == 13:
            self.pos = [self.pos[0], self.pos[1]]
            xpos13 = self.pos[0]
            ypos13 = self.pos[1]
        elif constants.ck % 20 == 14:
            xpos = self.pos[0]
            ypos = self.pos[1]
            x1pos = xpos + 10
            y1pos = ypos
            ...
            x24pos = xpos + 10 * math.cos(math.pi / 3)
            y24pos = ypos - 10 * math.sin(math.pi / 3)
            dis = math.sqrt((xpos - xpos13) * (xpos - xpos13) + (ypos - ypos13) * (ypos - ypos13))
            dist0 = math.sqrt((x1pos - xpos13) * (x1pos - xpos13) + (y1pos - ypos13) * (y1pos - ypos13))
            dist.append(dist0)
            dist1 = math.sqrt((x2pos - xpos13) * (x2pos - xpos13) + (y2pos - ypos13) * (y2pos - ypos13))
            dist.append(dist1)
            dist2 = math.sqrt((x3pos - xpos13) * (x3pos - xpos13) + (y3pos - ypos13) * (y3pos - ypos13))
            dist.append(dist2)
            dist3 = math.sqrt((x4pos - xpos13) * (x4pos - xpos13) + (y4pos - ypos13) * (y4pos - ypos13))
            dist.append(dist3)
            dist4 = math.sqrt((x5pos - xpos13) * (x5pos - xpos13) + (y5pos - ypos13) * (y5pos - ypos13))
            dist.append(dist4)
            dist5 = math.sqrt((x6pos - xpos13) * (x6pos - xpos13) + (y6pos - ypos13) * (y6pos - ypos13))
            dist.append(dist5)
            dist6 = math.sqrt((x7pos - xpos13) * (x7pos - xpos13) + (y7pos - ypos13) * (y7pos - ypos13))
            dist.append(dist6)
            dist7 = math.sqrt((x8pos - xpos13) * (x8pos - xpos13) + (y8pos - ypos13) * (y8pos - ypos13))
            dist.append(dist7)
            dist8 = math.sqrt((x9pos - xpos13) * (x9pos - xpos13) + (y9pos - ypos13) * (y9pos - ypos13))
            dist.append(dist8)
            dist9 = math.sqrt((x10pos - xpos13) * (x10pos - xpos13) + (y10pos - ypos13) * (y10pos - ypos13))
            dist.append(dist9)
            dist10 = math.sqrt((x11pos - xpos13) * (x11pos - xpos13) + (y11pos - ypos13) * (y11pos - ypos13))
            dist.append(dist10)
            dist11 = math.sqrt((x12pos - xpos13) * (x12pos - xpos13) + (y12pos - ypos13) * (y12pos - ypos13))
            dist.append(dist11)
            dist12 = math.sqrt((x13pos - xpos13) * (x13pos - xpos13) + (y13pos - ypos13) * (y13pos - ypos13))
            dist.append(dist12)
            dist13 = math.sqrt((x14pos - xpos13) * (x14pos - xpos13) + (y14pos - ypos13) * (y14pos - ypos13))
            dist.append(dist13)
            dist14 = math.sqrt((x15pos - xpos13) * (x15pos - xpos13) + (y15pos - ypos13) * (y15pos - ypos13))
            dist.append(dist14)
            dist15 = math.sqrt((x16pos - xpos13) * (x16pos - xpos13) + (y16pos - ypos13) * (y16pos - ypos13))
            dist.append(dist15)
            dist16 = math.sqrt((x17pos - xpos13) * (x17pos - xpos13) + (y17pos - ypos13) * (y17pos - ypos13))
            dist.append(dist16)
            dist17 = math.sqrt((x18pos - xpos13) * (x18pos - xpos13) + (y18pos - ypos13) * (y18pos - ypos13))
            dist.append(dist17)
            dist18 = math.sqrt((x19pos - xpos13) * (x19pos - xpos13) + (y19pos - ypos13) * (y19pos - ypos13))
            dist.append(dist18)
            dist19 = math.sqrt((x20pos - xpos13) * (x20pos - xpos13) + (y20pos - ypos13) * (y20pos - ypos13))
            dist.append(dist19)
            dist20 = math.sqrt((x21pos - xpos13) * (x21pos - xpos13) + (y21pos - ypos13) * (y21pos - ypos13))
            dist.append(dist20)
            dist21 = math.sqrt((x22pos - xpos13) * (x22pos - xpos13) + (y22pos - ypos13) * (y22pos - ypos13))
            dist.append(dist21)
            dist22 = math.sqrt((x23pos - xpos13) * (x23pos - xpos13) + (y23pos - ypos13) * (y23pos - ypos13))
            dist.append(dist22)
            dist23 = math.sqrt((x24pos - xpos13) * (x24pos - xpos13) + (y24pos - ypos13) * (y24pos - ypos13))
            dist.append(dist23)
            dixt = list(sorted(dist))
            for i in range(24):
                for j in range(24):
                    if dixt[i] == dist[j]:
                        if j == 0:
                            ...
                            dix9.append(dst9)
                            dst10 = math.sqrt(
                                (x10pos - xpos10) * (x10pos - xpos10) + (y10pos - ypos10) * (y10pos - ypos10))
                            dix9.append(dst10)
                            for k in range(10):
                                if dix9[k] < 50:
                                    pttr = 1
                            ...
                            dix10.append(dst9)
                            dst10 = math.sqrt(
                                (x11pos - xpos10) * (x11pos - xpos10) + (y11pos - ypos10) * (y11pos - ypos10))
                            dix10.append(dst10)
                            for k in range(10):
                                if dix10[k] < 50:
                                    pttr = 1
                            ...
                            dix11.append(dst9)
                            dst10 = math.sqrt(
                                (x12pos - xpos10) * (x12pos - xpos10) + (y12pos - ypos10) * (y12pos - ypos10))
                            dix11.append(dst10)
                            for k in range(10):
                                if dix11[k] < 50:
                                    pttr = 1
                            ...
                            dix12.append(dst9)
                            dst10 = math.sqrt(
                                (x13pos - xpos10) * (x13pos - xpos10) + (y13pos - ypos10) * (y13pos - ypos10))
                            dix12.append(dst10)
                            for k in range(10):
                                if dix12[k] < 50:
                                    pttr = 1
                            ...
                            dix14.append(dst9)
                            dst10 = math.sqrt(
                                (x15pos - xpos10) * (x15pos - xpos10) + (y15pos - ypos10) * (y15pos - ypos10))
                            dix14.append(dst10)
                            for k in range(10):
                                if dix14[k] < 50:
                                    pttr = 1
                            ...
                            dix15.append(dst9)
                            dst10 = math.sqrt(
                                (x16pos - xpos10) * (x16pos - xpos10) + (y16pos - ypos10) * (y16pos - ypos10))
                            dix15.append(dst10)
                            for k in range(10):
                                if dix15[k] < 50:
                                    pttr = 1
                            ...
                            dix16.append(dst9)
                            dst10 = math.sqrt(
                                (x17pos - xpos10) * (x17pos - xpos10) + (y18pos - ypos10) * (y19pos - ypos10))
                            dix16.append(dst10)
                            for k in range(10):
                                if dix16[k] < 50:
                                    pttr = 1
                            ...
                            dix17.append(dst9)
                            dst10 = math.sqrt(
                                (x18pos - xpos10) * (x18pos - xpos10) + (y18pos - ypos10) * (y18pos - ypos10))
                            dix17.append(dst10)
                            for k in range(10):
                                if dix17[k] < 50:
                                    pttr = 1
                            ...
                            dix18.append(dst9)
                            dst10 = math.sqrt(
                                (x19pos - xpos10) * (x19pos - xpos10) + (y19pos - ypos10) * (y19pos - ypos10))
                            dix18.append(dst10)
                            for k in range(10):
                                if dix18[k] < 50:
                                    pttr = 1
                            ...
                            dix19.append(dst9)
                            dst10 = math.sqrt(
                                (x20pos - xpos10) * (x20pos - xpos10) + (y20pos - ypos10) * (y20pos - ypos10))
                            dix19.append(dst10)
                            for k in range(10):
                                if dix19[k] < 50:
                                    pttr = 1
                            ...
                            dix20.append(dst9)
                            dst10 = math.sqrt(
                                (x21pos - xpos10) * (x21pos - xpos10) + (y21pos - ypos10) * (y21pos - ypos10))
                            dix20.append(dst10)
                            for k in range(10):
                                if dix20[k] < 50:
                                    pttr = 1
                            ...
                            dix21.append(dst9)
                            dst10 = math.sqrt(
                                (x22pos - xpos10) * (x22pos - xpos10) + (y22pos - ypos10) * (y22pos - ypos10))
                            dix21.append(dst10)
                            for k in range(10):
                                if dix21[k] < 50:
                                    pttr = 1
                            ...
                            dix22.append(dst9)
                            dst10 = math.sqrt(
                                (x23pos - xpos10) * (x23pos - xpos10) + (y23pos - ypos10) * (y23pos - ypos10))
                            dix22.append(dst10)
                            for k in range(10):
                                if dix22[k] < 50:
                                    pttr = 1
                            ...
                            dix23.append(dst9)
                            dst10 = math.sqrt(
                                (x24pos - xpos10) * (x24pos - xpos10) + (y24pos - ypos10) * (y24pos - ypos10))
                            dix23.append(dst10)
                            for k in range(10):
                                if dix23[k] < 50:
                                    pttr = 1
        ...
        elif constants.ck % 20 == 15:
            self.pos = [self.pos[0], self.pos[1]]
            xpos15 = self.pos[0]
            ypos15 = self.pos[1]
        elif constants.ck % 20 == 16:
            xpos = self.pos[0]
            ypos = self.pos[1]
            x1pos = xpos + 10
            y1pos = ypos
            ...
            x24pos = xpos + 10 * math.cos(math.pi / 3)
            y24pos = ypos - 10 * math.sin(math.pi / 3)
            dis = math.sqrt((xpos - xpos15) * (xpos - xpos15) + (ypos - ypos15) * (ypos - ypos15))
            dist0 = math.sqrt((x1pos - xpos15) * (x1pos - xpos15) + (y1pos - ypos15) * (y1pos - ypos15))
            dist.append(dist0)
            dist1 = math.sqrt((x2pos - xpos15) * (x2pos - xpos15) + (y2pos - ypos15) * (y2pos - ypos15))
            dist.append(dist1)
            dist2 = math.sqrt((x3pos - xpos15) * (x3pos - xpos15) + (y3pos - ypos15) * (y3pos - ypos15))
            dist.append(dist2)
            dist3 = math.sqrt((x4pos - xpos15) * (x4pos - xpos15) + (y4pos - ypos15) * (y4pos - ypos15))
            dist.append(dist3)
            dist4 = math.sqrt((x5pos - xpos15) * (x5pos - xpos15) + (y5pos - ypos15) * (y5pos - ypos15))
            dist.append(dist4)
            dist5 = math.sqrt((x6pos - xpos15) * (x6pos - xpos15) + (y6pos - ypos15) * (y6pos - ypos15))
            dist.append(dist5)
            dist6 = math.sqrt((x7pos - xpos15) * (x7pos - xpos15) + (y7pos - ypos15) * (y7pos - ypos15))
            dist.append(dist6)
            dist7 = math.sqrt((x8pos - xpos15) * (x8pos - xpos15) + (y8pos - ypos15) * (y8pos - ypos15))
            dist.append(dist7)
            dist8 = math.sqrt((x9pos - xpos15) * (x9pos - xpos15) + (y9pos - ypos15) * (y9pos - ypos15))
            dist.append(dist8)
            dist9 = math.sqrt((x10pos - xpos15) * (x10pos - xpos15) + (y10pos - ypos15) * (y10pos - ypos15))
            dist.append(dist9)
            dist10 = math.sqrt((x11pos - xpos15) * (x11pos - xpos15) + (y11pos - ypos15) * (y11pos - ypos15))
            dist.append(dist10)
            dist11 = math.sqrt((x12pos - xpos15) * (x12pos - xpos15) + (y12pos - ypos15) * (y12pos - ypos15))
            dist.append(dist11)
            dist12 = math.sqrt((x13pos - xpos15) * (x13pos - xpos15) + (y13pos - ypos15) * (y13pos - ypos15))
            dist.append(dist12)
            dist13 = math.sqrt((x14pos - xpos15) * (x14pos - xpos15) + (y14pos - ypos15) * (y14pos - ypos15))
            dist.append(dist13)
            dist14 = math.sqrt((x15pos - xpos15) * (x15pos - xpos15) + (y15pos - ypos15) * (y15pos - ypos15))
            dist.append(dist14)
            dist15 = math.sqrt((x16pos - xpos15) * (x16pos - xpos15) + (y16pos - ypos15) * (y16pos - ypos15))
            dist.append(dist15)
            dist16 = math.sqrt((x17pos - xpos15) * (x17pos - xpos15) + (y17pos - ypos15) * (y17pos - ypos15))
            dist.append(dist16)
            dist17 = math.sqrt((x18pos - xpos15) * (x18pos - xpos15) + (y18pos - ypos15) * (y18pos - ypos15))
            dist.append(dist17)
            dist18 = math.sqrt((x19pos - xpos15) * (x19pos - xpos15) + (y19pos - ypos15) * (y19pos - ypos15))
            dist.append(dist18)
            dist19 = math.sqrt((x20pos - xpos15) * (x20pos - xpos15) + (y20pos - ypos15) * (y20pos - ypos15))
            dist.append(dist19)
            dist20 = math.sqrt((x21pos - xpos15) * (x21pos - xpos15) + (y21pos - ypos15) * (y21pos - ypos15))
            dist.append(dist20)
            dist21 = math.sqrt((x22pos - xpos15) * (x22pos - xpos15) + (y22pos - ypos15) * (y22pos - ypos15))
            dist.append(dist21)
            dist22 = math.sqrt((x23pos - xpos15) * (x23pos - xpos15) + (y23pos - ypos15) * (y23pos - ypos15))
            dist.append(dist22)
            dist23 = math.sqrt((x24pos - xpos15) * (x24pos - xpos15) + (y24pos - ypos15) * (y24pos - ypos15))
            dist.append(dist23)
            dixt = list(sorted(dist))
            for i in range(24):
                for j in range(24):
                    if dixt[i] == dist[j]:
                        if j == 0:
                            ...
                            dix13.append(dst9)
                            dst10 = math.sqrt(
                                (x14pos - xpos10) * (x14pos - xpos10) + (y14pos - ypos10) * (y14pos - ypos10))
                            dix13.append(dst10)
                            for k in range(10):
                                if dix13[k] < 50:
                                    pttr = 1
            ...
            del dix22[:]
            del dix23[:]
        elif constants.ck % 20 == 17:
            self.pos = [self.pos[0], self.pos[1]]
            xpos17 = self.pos[0]
            ypos17 = self.pos[1]
        elif constants.ck % 20 == 18:
            xpos = self.pos[0]
            ypos = self.pos[1]
            x1pos = xpos + 10
            y1pos = ypos
            ...
            x24pos = xpos + 10 * math.cos(math.pi / 3)
            y24pos = ypos - 10 * math.sin(math.pi / 3)
            dis = math.sqrt((xpos - xpos17) * (xpos - xpos17) + (ypos - ypos17) * (ypos - ypos17))
            dist0 = math.sqrt((x1pos - xpos17) * (x1pos - xpos17) + (y1pos - ypos17) * (y1pos - ypos17))
            dist.append(dist0)
            dist1 = math.sqrt((x2pos - xpos17) * (x2pos - xpos17) + (y2pos - ypos17) * (y2pos - ypos17))
            dist.append(dist1)
            dist2 = math.sqrt((x3pos - xpos17) * (x3pos - xpos17) + (y3pos - ypos17) * (y3pos - ypos17))
            dist.append(dist2)
            dist3 = math.sqrt((x4pos - xpos17) * (x4pos - xpos17) + (y4pos - ypos17) * (y4pos - ypos17))
            dist.append(dist3)
            dist4 = math.sqrt((x5pos - xpos17) * (x5pos - xpos17) + (y5pos - ypos17) * (y5pos - ypos17))
            dist.append(dist4)
            dist5 = math.sqrt((x6pos - xpos17) * (x6pos - xpos17) + (y6pos - ypos17) * (y6pos - ypos17))
            dist.append(dist5)
            dist6 = math.sqrt((x7pos - xpos17) * (x7pos - xpos17) + (y7pos - ypos17) * (y7pos - ypos17))
            dist.append(dist6)
            dist7 = math.sqrt((x8pos - xpos17) * (x8pos - xpos17) + (y8pos - ypos17) * (y8pos - ypos17))
            dist.append(dist7)
            dist8 = math.sqrt((x9pos - xpos17) * (x9pos - xpos17) + (y9pos - ypos17) * (y9pos - ypos17))
            dist.append(dist8)
            dist9 = math.sqrt((x10pos - xpos17) * (x10pos - xpos17) + (y10pos - ypos17) * (y10pos - ypos17))
            dist.append(dist9)
            dist10 = math.sqrt((x11pos - xpos17) * (x11pos - xpos17) + (y11pos - ypos17) * (y11pos - ypos17))
            dist.append(dist10)
            dist11 = math.sqrt((x12pos - xpos17) * (x12pos - xpos17) + (y12pos - ypos17) * (y12pos - ypos17))
            dist.append(dist11)
            dist12 = math.sqrt((x13pos - xpos17) * (x13pos - xpos17) + (y13pos - ypos17) * (y13pos - ypos17))
            dist.append(dist12)
            dist13 = math.sqrt((x14pos - xpos17) * (x14pos - xpos17) + (y14pos - ypos17) * (y14pos - ypos17))
            dist.append(dist13)
            dist14 = math.sqrt((x15pos - xpos17) * (x15pos - xpos17) + (y15pos - ypos17) * (y15pos - ypos17))
            dist.append(dist14)
            dist15 = math.sqrt((x16pos - xpos17) * (x16pos - xpos17) + (y16pos - ypos17) * (y16pos - ypos17))
            dist.append(dist15)
            dist16 = math.sqrt((x17pos - xpos17) * (x17pos - xpos17) + (y17pos - ypos17) * (y17pos - ypos17))
            dist.append(dist16)
            dist17 = math.sqrt((x18pos - xpos17) * (x18pos - xpos17) + (y18pos - ypos17) * (y18pos - ypos17))
            dist.append(dist17)
            dist18 = math.sqrt((x19pos - xpos17) * (x19pos - xpos17) + (y19pos - ypos17) * (y19pos - ypos17))
            dist.append(dist18)
            dist19 = math.sqrt((x20pos - xpos17) * (x20pos - xpos17) + (y20pos - ypos17) * (y20pos - ypos17))
            dist.append(dist19)
            dist20 = math.sqrt((x21pos - xpos17) * (x21pos - xpos17) + (y21pos - ypos17) * (y21pos - ypos17))
            dist.append(dist20)
            dist21 = math.sqrt((x22pos - xpos17) * (x22pos - xpos17) + (y22pos - ypos17) * (y22pos - ypos17))
            dist.append(dist21)
            dist22 = math.sqrt((x23pos - xpos17) * (x23pos - xpos17) + (y23pos - ypos17) * (y23pos - ypos17))
            dist.append(dist22)
            dist23 = math.sqrt((x24pos - xpos17) * (x24pos - xpos17) + (y24pos - ypos17) * (y24pos - ypos17))
            dist.append(dist23)
            dixt = list(sorted(dist))
            for i in range(24):
                for j in range(24):
            ...
            del dix22[:]
            del dix23[:]
        elif constants.ck % 20 == 19:
            self.pos = [self.pos[0], self.pos[1]]
            xpos19 = self.pos[0]
            ypos19 = self.pos[1]
        elif constants.ck % 20 == 0:
            xpos = self.pos[0]
            ypos = self.pos[1]
            x1pos = xpos + 10
            y1pos = ypos
            ...
            x24pos = xpos + 10 * math.cos(math.pi / 3)
            y24pos = ypos - 10 * math.sin(math.pi / 3)
            dis = math.sqrt((xpos - xpos19) * (xpos - xpos19) + (ypos - ypos19) * (ypos - ypos19))
            dist0 = math.sqrt((x1pos - xpos19) * (x1pos - xpos19) + (y1pos - ypos19) * (y1pos - ypos19))
            dist.append(dist0)
            dist1 = math.sqrt((x2pos - xpos19) * (x2pos - xpos19) + (y2pos - ypos19) * (y2pos - ypos19))
            dist.append(dist1)
            dist2 = math.sqrt((x3pos - xpos19) * (x3pos - xpos19) + (y3pos - ypos19) * (y3pos - ypos19))
            dist.append(dist2)
            dist3 = math.sqrt((x4pos - xpos19) * (x4pos - xpos19) + (y4pos - ypos19) * (y4pos - ypos19))
            dist.append(dist3)
            dist4 = math.sqrt((x5pos - xpos19) * (x5pos - xpos19) + (y5pos - ypos19) * (y5pos - ypos19))
            dist.append(dist4)
            dist5 = math.sqrt((x6pos - xpos19) * (x6pos - xpos19) + (y6pos - ypos19) * (y6pos - ypos19))
            dist.append(dist5)
            dist6 = math.sqrt((x7pos - xpos19) * (x7pos - xpos19) + (y7pos - ypos19) * (y7pos - ypos19))
            dist.append(dist6)
            dist7 = math.sqrt((x8pos - xpos19) * (x8pos - xpos19) + (y8pos - ypos19) * (y8pos - ypos19))
            dist.append(dist7)
            dist8 = math.sqrt((x9pos - xpos19) * (x9pos - xpos19) + (y9pos - ypos19) * (y9pos - ypos19))
            dist.append(dist8)
            dist9 = math.sqrt((x10pos - xpos19) * (x10pos - xpos19) + (y10pos - ypos19) * (y10pos - ypos19))
            dist.append(dist9)
            dist10 = math.sqrt((x11pos - xpos19) * (x11pos - xpos19) + (y11pos - ypos19) * (y11pos - ypos19))
            dist.append(dist10)
            dist11 = math.sqrt((x12pos - xpos19) * (x12pos - xpos19) + (y12pos - ypos19) * (y12pos - ypos19))
            dist.append(dist11)
            dist12 = math.sqrt((x13pos - xpos19) * (x13pos - xpos19) + (y13pos - ypos19) * (y13pos - ypos19))
            dist.append(dist12)
            dist13 = math.sqrt((x14pos - xpos19) * (x14pos - xpos19) + (y14pos - ypos19) * (y14pos - ypos19))
            dist.append(dist13)
            dist14 = math.sqrt((x15pos - xpos19) * (x15pos - xpos19) + (y15pos - ypos19) * (y15pos - ypos19))
            dist.append(dist14)
            dist15 = math.sqrt((x16pos - xpos19) * (x16pos - xpos19) + (y16pos - ypos19) * (y16pos - ypos19))
            dist.append(dist15)
            dist16 = math.sqrt((x17pos - xpos19) * (x17pos - xpos19) + (y17pos - ypos19) * (y17pos - ypos19))
            dist.append(dist16)
            dist17 = math.sqrt((x18pos - xpos19) * (x18pos - xpos19) + (y18pos - ypos19) * (y18pos - ypos19))
            dist.append(dist17)
            dist18 = math.sqrt((x19pos - xpos19) * (x19pos - xpos19) + (y19pos - ypos19) * (y19pos - ypos19))
            dist.append(dist18)
            dist19 = math.sqrt((x20pos - xpos19) * (x20pos - xpos19) + (y20pos - ypos19) * (y20pos - ypos19))
            dist.append(dist19)
            dist20 = math.sqrt((x21pos - xpos19) * (x21pos - xpos19) + (y21pos - ypos19) * (y21pos - ypos19))
            dist.append(dist20)
            dist21 = math.sqrt((x22pos - xpos19) * (x22pos - xpos19) + (y22pos - ypos19) * (y22pos - ypos19))
            dist.append(dist21)
            dist22 = math.sqrt((x23pos - xpos19) * (x23pos - xpos19) + (y23pos - ypos19) * (y23pos - ypos19))
            dist.append(dist22)
            dist23 = math.sqrt((x24pos - xpos19) * (x24pos - xpos19) + (y24pos - ypos19) * (y24pos - ypos19))
            dist.append(dist23)
            dixt = list(sorted(dist))
            for i in range(24):
                for j in range(24):
